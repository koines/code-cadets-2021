...
const betDtoFetchSpecificIdPath = "/bet/:id"
const betDtoFetchAllPath = "/user/:id/bets"
const betDtoFetchSpecificStatusPath = "/bets"
...
func (w *WebServer) registerRoutes(ctrl Controller) {
	w.router.GET(betDtoFetchAllPath, ctrl.FetchAll())
	w.router.GET(betDtoFetchSpecificIdPath, ctrl.FetchSpecificId())
	w.router.GET(betDtoFetchSpecificStatusPath, ctrl.FetchSpecificStatus())
}

// Controller handles api calls
type Controller interface {
	FetchAll() gin.HandlerFunc
	FetchSpecificId() gin.HandlerFunc
	FetchSpecificStatus() gin.HandlerFunc
}
